...
export const hunterData: readonly hunterDatum[] = [
  ...
  },
  {
    ...
    primaryCoolTime: [19, 7],
    secondaryNameJa: "驚波",
    secondaryNameEn: "Surging\nTides",
    secondaryCoolTime: [40],
  },
  {
    nameJa: "蝋人形師",
    nameEn: "Wax Artist",
  ...
  },
  {
    ...
    secondaryCoolTime: [24],
    tertiaryNameJa: "影襲",
    tertiaryNameEn: "Shadow-\nstrike",
    tertiaryCoolTime: [20, 5],
  },
  {
    nameJa: "「フールズ・ゴールド」",
    nameEn: '"Fool\'s Gold"',
